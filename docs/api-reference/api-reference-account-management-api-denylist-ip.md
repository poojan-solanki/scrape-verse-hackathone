...
> **Official Source**: [https://docs.brightdata.com/api-reference/account-management-api/denylist-ip](https://docs.brightdata.com/api-reference/account-management-api/denylist-ip)
> **Category**: `api-reference`

---

api-reference/openapi POST /zone/blacklist
