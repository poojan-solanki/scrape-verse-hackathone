...
> **Official Source**: [https://docs.brightdata.com/api-reference/account-management-api/Change_account_status](https://docs.brightdata.com/api-reference/account-management-api/Change_account_status)
> **Category**: `api-reference`

---

api-reference/openapi PUT /status
