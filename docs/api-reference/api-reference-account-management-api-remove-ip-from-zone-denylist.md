...
> **Official Source**: [https://docs.brightdata.com/api-reference/account-management-api/remove-ip-from-zone-denylist](https://docs.brightdata.com/api-reference/account-management-api/remove-ip-from-zone-denylist)
> **Category**: `api-reference`

---

api-reference/openapi DELETE /zone/blacklist
