...
> **Official Source**: [https://docs.brightdata.com/api-reference/account-management-api/remove-ip-from-zone-allowlist](https://docs.brightdata.com/api-reference/account-management-api/remove-ip-from-zone-allowlist)
> **Category**: `api-reference`

---

api-reference/openapi DELETE /zone/whitelist
