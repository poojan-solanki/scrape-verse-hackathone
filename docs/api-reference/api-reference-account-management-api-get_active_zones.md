...
> **Official Source**: [https://docs.brightdata.com/api-reference/account-management-api/Get_active_Zones](https://docs.brightdata.com/api-reference/account-management-api/Get_active_Zones)
> **Category**: `api-reference`

---

api-reference/openapi GET /zone/get_active_zones
