...
> **Official Source**: [https://docs.brightdata.com/api-reference/postman-collection](https://docs.brightdata.com/api-reference/postman-collection)
> **Category**: `api-reference`

---

Quickly test and explore Bright Data's APIs (1000+ scrapers) using our Postman collection. View, run and fork requests without setting up your own backend.

<div>
  <Card title="Postman collection" icon="user-astronaut" href="https://www.postman.com/bright-data-api/bright-data-api/collection/2f4u0m8/bright-data-api-collection" />
</div>
...
2. **Update Postman collection environment variable**: Set your `BRIGHT_DATA_API_KEY` in the Postman collection environment variables under Production environment.
   <img alt="postman-collection-environment-varaible.jpg" />
