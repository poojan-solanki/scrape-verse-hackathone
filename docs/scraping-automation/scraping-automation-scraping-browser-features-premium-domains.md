# Browser API: premium domains

> **Official Source**: [https://docs.brightdata.com/scraping-automation/scraping-browser/features/premium-domains](https://docs.brightdata.com/scraping-automation/scraping-browser/features/premium-domains)
> **Category**: `scraping-automation`

---

Enable Premium Domains on the Bright Data Browser API to unblock the hardest target sites, with pricing shown in your zone cost estimate before activation.
