...
> **Official Source**: [https://docs.brightdata.com/scraping-automation/scraping-browser/cdp-functions/custom](https://docs.brightdata.com/scraping-automation/scraping-browser/cdp-functions/custom)
> **Category**: `scraping-automation`

---

Reference for Bright Data Browser API custom CDP functions (60+ tools) that extend the standard Chrome DevTools Protocol with unblocking and session controls.
