...
> **Official Source**: [https://docs.brightdata.com/scraping-automation/scraping-browser/faqs](https://docs.brightdata.com/scraping-automation/scraping-browser/faqs)
...
<AccordionGroup>
    ...
    * Remotely via your script.
      ...
      <Tabs>
        <Tab title="via Control Panel">
          ...
          4. On the right side, Click on the "Chrome Dev Tools Debugger" button <img alt="chrome-devtools-debugger.png" /> **Getting Started with the Debugger & Chrome Dev Tools**
      ...
      * Utilize the Dev Tools interface to inspect HTML elements, analyze network requests, debug JavaScript code, and monitor performance. Leverage breakpoints, console logging, and other debugging techniques to identify and resolve issues within your code. <img alt="test-sites.png" />
  </Accordion>
  ...
  <Accordion title="Which status codes does the Browser API return for errors?">
    ...
    | :------------------------------ | :-------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------- |
    | Unexpected server response: 407 | An issue with the remote browser's port | Check your remote browser's port. The correct port for the Browser API is `9222`.                                                                           |
