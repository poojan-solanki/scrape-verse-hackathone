...
> **Official Source**: [https://docs.brightdata.com/scraping-automation/scraping-browser/cdp-functions/standard](https://docs.brightdata.com/scraping-automation/scraping-browser/cdp-functions/standard)
> **Category**: `scraping-automation`

---

Reference for standard CDP functions on the Bright Data Browser API (60+ tools): cookies, country targeting, navigation and Puppeteer or Playwright commands.
