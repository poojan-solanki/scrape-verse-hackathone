...
> **Official Source**: [https://docs.brightdata.com/proxy-networks/isp/send-your-first-request](https://docs.brightdata.com/proxy-networks/isp/send-your-first-request)
> **Category**: `proxy-networks`

---

Send your first request through Bright Data ISP proxies with copy-paste code examples in cURL, Python, Node.js, Java, and Go.
