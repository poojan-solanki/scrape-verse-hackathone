...
> **Official Source**: [https://docs.brightdata.com/datasets/deep-lookup/pricing](https://docs.brightdata.com/datasets/deep-lookup/pricing)
...
<CardGroup>
  <Card title="Free Trial" icon="" href="https://brightdata.com/products/deep-lookup">
    * \- 5 queries included
  ...
  <Card title="Pay As You Go" icon="" href="https://brightdata.com/products/deep-lookup">
  ...
  <Card title="Enterprise" icon="" href="mailto:sales@brightdata.com">
    * \- Volume discounts
    * \- Custom pricing
    * \- Dedicated support
    * \- API access
