...
> **Official Source**: [https://docs.brightdata.com/datasets/scrapers/twitter/data-delivery/webhooks](https://docs.brightdata.com/datasets/scrapers/twitter/data-delivery/webhooks)
